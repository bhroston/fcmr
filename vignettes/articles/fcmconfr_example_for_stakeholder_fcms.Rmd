---
title: "fcmconfr_example_for_stakeholder_fcms"
---
...
```{r include=FALSE}
filepath <- filepath <- file.path(here::here(), "vignettes", "vignette_example_data", "conventional_fcms", "sample_conventional_fcms.xlsx")
```
...
```{r include=FALSE}
directory_path <- 
  file.path(here::here(), "vignettes", "vignette_example_data", "conventional_fcms", "conventional_fcms_dir") # You directory path here
```
...
```{r include=FALSE}
filepath <- file.path(here::here(), "vignettes", "vignette_example_data", "ivfn_fcms", "sample_ivfn_fcm.xlsx") # Your directory path above
```
...
```{r include=FALSE}
directory_path <- file.path(here::here(), "vignettes", "vignette_example_data", "ivfn_fcms", "ivfn_fcm_dirs", "fcm_1") # Your directory path here
```
...
```{r include=FALSE}
directory_path <- file.path(here::here(), "vignettes", "vignette_example_data", "ivfn_fcms", "ivfn_fcm_ind_files") # Your directory path here
```
...
```{r include=FALSE}
directory_path <- file.path(here::here(), "vignettes", "vignette_example_data", "ivfn_fcms", "ivfn_fcm_dirs") # Your directory path here
```
...
```{r include=FALSE}
filepath <- file.path(here::here(), "vignettes", "vignette_example_data", "tfn_fcms", "sample_tfn_fcm.xlsx") # Your directory path here
```
...
```{r include=FALSE}
directory_path <- file.path(here::here(), "vignettes", "vignette_example_data", "tfn_fcms", "tfn_fcm_dirs", "fcm_1") # Your directory path here
```
...
```{r include=FALSE}
directory_path <- file.path(here::here(), "vignettes", "vignette_example_data", "tfn_fcms", "tfn_fcm_ind_files") # Your directory path here
```
...
```{r include=FALSE}
directory_path <- file.path(here::here(), "vignettes", "vignette_example_data", "tfn_fcms", "tfn_fcm_dirs") # Your directory path here
```
