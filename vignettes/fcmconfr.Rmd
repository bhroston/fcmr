...
Note: At its core, `fcm_view()` is just a call to `visNetwork` functions. Users who have experience with `visNetwork` should feel free to plot FCMs directly with `visNetwork` for greater flexibility.
