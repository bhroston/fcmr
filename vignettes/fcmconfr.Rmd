...
The `get_inferences()` function returns only the inferences as is typical across FCM studies, but users interested in the many simulations' time-series can still access them from the output of `fcmconfr()`.
...
### 4.3 Getting Simulation Time-Series 
