...
mc_fcms <- build_monte_carlo_fcms_from_fuzzy_set_adj_matrices(fcms_w_ivfns, "ivfn", 1000, include_zeroes = FALSE)
mc_fcms_inferences <- infer_monte_carlo_fcm_set(
  mc_adj_matrices = mc_fcms,
...
mc_fcms <- build_monte_carlo_fcms_from_fuzzy_set_adj_matrices(fcms_w_tfns, "tfn", 1000, include_zeroes = FALSE)
mc_fcms_inferences <- infer_monte_carlo_fcm_set(
  mc_adj_matrices = mc_fcms,
  initial_state_vector <- c(1, 1),
  clamping_vector <- c(1, 0),
