...
ex_tfn_adj_matrix <- make_adj_matrix_w_tfns(lower_adj_matrix, mode_adj_matrix, upper_adj_matrix)

convert_fuzzy_set_elements_in_matrix_to_distributions(ex_tfn_adj_matrix, "tfn", 1000)
