...
build_monte_carlo_fcms(ex_fcms, N_samples = 1000, include_zeroes = FALSE, show_progress = TRUE)
...
build_monte_carlo_fcms(fcms_w_ivfns, "ivfn", 1000, include_zeroes = FALSE)
...
build_monte_carlo_fcms(fcms_w_tfns, "tfn", 1000, include_zeroes = FALSE)
