...
test_that("infer_fgcm_with_pulse works", {
  ...
  #   test_initial_state_vector = c(C1, C2, C3, C4, C5, C6, C7, C8)
  #
  #   test_fgcmr_simulation <- infer_fgcm_with_pulser(test_grey_adj_matrix, test_initial_state_vector, lambda = 1, activation = "modified-kosko", max_iter = 100, min_error = 1e-8)
  #
  #
  #
  #
...
test_that("warning pops up if max_iter reached", {
  ...
  expect_warning(infer_fgcm_with_pulse(grey_adj_matrix, initial_state_vector,
